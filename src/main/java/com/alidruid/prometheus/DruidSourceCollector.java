...
public class DruidSourceCollector extends Collector {

    private static final List<String> LABEL_NAMES = Collections.singletonList("pool");

    private DruidDataSource druidDataSource;

    public DruidSourceCollector(DruidDataSource druidDataSource){
    ...
    private GaugeMetricFamily createGauge(String metric, String help,
        ...
        metricFamily.addMetric(Arrays.asList(druidDataSource.getName()),metricValueFunction.apply(druidDataSource));
        return metricFamily;
    }
}
